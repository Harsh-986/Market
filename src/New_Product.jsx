    ...
    <div className="featured-products">
      ...
      <div className="product-grid">
        <div className="product-card">
          ...
          <Link to="/ProductPage" className="link-unique"><h3 className="product-title">Cupim Bris</h3></Link>
        ...
        <div className="product-card">
          ...
          <Link to="/ProductPage" className="link-unique"><h3 className="product-title">Cisi Chicken</h3></Link>
          <div className="product-rating">★★★★☆</div>
          <div className="product-price">
        ...
        <div className="product-card">
          ...
          <Link to="/ProductPage" className="link-unique"><h3 className="product-title">Bint Beef</h3></Link>
          <div className="product-rating">★★★★☆</div>
          <div className="product-price">
        ...
        <div className="product-card">
          ...
          <Link to="/ProductPage" className="link-unique"><h3 className="product-title">Dail Lulpa</h3></Link>
          <div className="product-rating">★★★★☆</div>
          <div className="product-price">
            <span className="current-price">$97.00</span>
          </div>
